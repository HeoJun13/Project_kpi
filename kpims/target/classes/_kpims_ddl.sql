...
CREATE TABLE MEMBER(
	MEMBER_CD 		INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE ADDRESS(
	 ADDRESS_CD		BIGINT AUTO_INCREMENT PRIMARY KEY,
	 MEMBER_ID 		  VARCHAR(30), 				# NOT NULL
	 RECIPIENT_NM 	  VARCHAR(50),				# NOT NULL
	 MEMBER_CD		  INT,						# NOT NULL
	 POSTCODE 		  VARCHAR(10),
	 ADDRESS 		  VARCHAR(500),
	 DETAIL_ADDRESS   VARCHAR(500),
	 RECIPIENT_HP 	  VARCHAR(20), 				# NOT NULL
	 DELIVERY_REQIEST VARCHAR(20),				# NOT NULL
	 JOIN_DT 		  TIMESTAMP					# NOT NULL
	 );


CREATE TABLE SHOP(
    SHOP_CD 		  INT AUTO_INCREMENT PRIMARY KEY,
    SHOP_NM 		  VARCHAR(500),						# NOT NULL
	...
	INTRO 			  VARCHAR(3000),
	PURCHASE_REVIEW   VARCHAR(3000),
    QUESTION		  VARCHAR(3000),
	SHOP_FILE_NAME	  VARCHAR(300),						# NOT NULL UNIQUE

        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="${contextPath}/admin/project/main" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Bogogah</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="${contextPath}/admin/project/main" class="menu-link">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">회원관리</div>
              </a>
